...
;                  |1 - UTF-8-String
;                  |2 - binary data
; Return values .: Same as for _WinHttpReadData except due to async nature here it has no meaning except in case of possible error.
; Author ........: trancexx
; Modified.......:
; Remarks .......: WinHttp is rentrant during asynchronous completion callback. Make sure you have only one callback running and only one session hanlded though it.
;                  Make sure memory buffer is at least 8192 bytes in size if $iNumberOfBytesToRead is left default.
